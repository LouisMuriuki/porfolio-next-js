...
import { fadeAnimation, headContainerAnimation, headTextAnimation, slideAnimation } from "../config/motion";
const Main = () => {
  useEffect(() => {
      ...
      <motion.div id="home" className="w-full h-screen text-center">
        <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center">
          <div>
            ...
            <motion.div {...slideAnimation("up")} className="flex items-center justify-between nax-w-[330px] m-auto py-4">
